...
export default function HomeDiscover() {
  return (
    <div className="w-full bg-white shadow-lg rounded-2xl dark:bg-gray-700 shadow-xl shadow-purple-500/50 dark:shadow-xl dark:shadow-purple-800/80">
      <div className="flex items-center justify-between p-4">
        <p className="font-bold text-black text-md dark:text-white text-black">
      ...
      <div className="flex items-center justify-between px-4 py-4 text-gray-600 border-b-2 border-gray-100">
        <p className="flex items-center text-xs dark:text-white">
          <svg
            width="20"
            height="20"
          ...
          juancieri - mirarte c/ lucas
        </p>
        <div className="flex items-center">
          <span className="ml-2 mr-2 text-xs text-gray-400 md:ml-4">2:52 min</span>
          <button className="p-1 mr-4 text-sm text-gray-400 border border-gray-400 rounded">
            <svg width="15" height="15" fill="currentColor" viewBox="0 0 20 20">
              <g fill="none">
                <path
      ...
      <div className="flex items-center justify-between px-4 py-4 text-gray-600 border-b-2 border-gray-100">
        <p className="flex items-center text-xs dark:text-white">
          ...
          juancieri - verte c/ lucas
        </p>
        <div className="flex items-center">
          <span className="ml-2 mr-2 text-xs text-gray-400 md:ml-4">3:12 min</span>
          <button className="p-1 mr-4 text-sm text-gray-400 border border-gray-400 rounded">
            <svg width="15" height="15" fill="currentColor" viewBox="0 0 20 20">
              <g fill="none">
                <path
      ...
      <div className="flex items-center justify-between px-4 py-4 text-gray-600">
        <p className="flex items-center text-xs dark:text-white">
          ...
          juancieri - observarte c/ lucas
        </p>
        <div className="flex items-center">
          <span className="ml-2 mr-2 text-xs text-gray-400 md:ml-4">2:12 min</span>
          <button className="p-1 mr-4 text-sm text-gray-400 border border-gray-400 rounded">
            <svg width="15" height="15" fill="currentColor" viewBox="0 0 20 20">
              <g fill="none">
                <path
