...
export default function Footer() {
  return (
    <footer class="px-3 py-8 text-gray-500 transition-colors duration-200 bg-white dark:bg-gray-800 text-2 dark:text-gray-200 w-full">
      <div class="flex flex-col">
        ...
        <div class="flex flex-col mt-4 md:mt-0 md:flex-row">
          ...
          <div class="flex items-center justify-center flex-1 mt-4 border-gray-100 md:mt-0 md:border-r gap-3">
            <a
              class="hover:text-primary-gray-20"
              href="https://github.com/JuanjoCieri"
            >
          ...
          <div class="flex flex-col items-center justify-center flex-1 mt-7 md:mt-0 md:items-start md:pl-5">
            ...
            <span class="mt-7 md:mt-1 flex justify-center items-center gap-0.5">
              Created by Juan José Cieri
            </span>
          </div>
        </div>
      </div>
